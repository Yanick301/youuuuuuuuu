...
export const products: Product[] = [
  ...
  {
    id: 'acc-107',
    name: 'Elegante goldene Damenuhr',
    name_fr: 'Montre Élégante Dorée',
    name_en: 'Elegant Golden Watch',
    slug: 'montre-elegante-doree-golden-lady',
    price: 260,
    description: 'Ein Hauch von Glamour mit dieser eleganten goldenen Uhr, perfekt für besondere Anlässe.',
    description_fr: 'Une touche de glamour avec cette élégante montre dorée, parfaite pour les occasions spéciales.',
    description_en: 'A touch of glamour with this elegant golden watch, perfect for special occasions.',
    category: 'accessories',
  ...
  {
    id: 'acc-108',
    name: 'Minimalistische silberne Uhr',
    name_fr: 'Montre Minimaliste Argentée',
    name_en: 'Minimalist Silver Watch',
    slug: 'montre-argentee-minimaliste-silver-pure',
    price: 150,
    description: 'Weniger ist mehr mit diesem minimalistischen Design, das ein sauberes silbernes Finish aufweist.',
    description_fr: 'Le moins est le plus avec ce design minimaliste, arborant une finition argentée épurée.',
    description_en: 'Less is more with this minimalist design, featuring a clean silver finish.',
    category: 'accessories',
  ...
  },
  {
    id: 'acc-109',
    name: 'Beige Lederuhr',
    name_fr: 'Montre en Cuir Beige',
    name_en: 'Beige Leather Watch',
    slug: 'montre-cuir-beige-soft-elegance',
    price: 230,
    description: 'Weiche Eleganz mit einem beigen Lederarmband, das Vielseitigkeit und Stil bietet.',
    description_fr: 'L\'élégance douce avec un bracelet en cuir beige, offrant polyvalence et style.',
    description_en: 'Soft elegance with a beige leather strap, offering versatility and style.',
    category: 'accessories',
  ...
  {
    id: 'acc-110',
    name: 'Roségold Milanese Uhr',
    name_fr: 'Montre Or Rose Milanaise',
    name_en: 'Rose Gold Milanese Watch',
    slug: 'montre-rose-gold-maille-milanaise-rose-queen',
    price: 290,
    description: 'Eine raffinierte Uhr mit einem Milanese-Armband aus Roségold für einen modernen und schicken Look.',
    description_fr: 'Une montre sophistiquée avec un bracelet milanais en or rose pour un look moderne et chic.',
    description_en: 'A sophisticated watch featuring a rose gold Milanese mesh strap for a modern, chic look.',
    category: 'accessories',
