      ...
      <section className="relative h-[60vh] w-full text-white">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center text-center">
          ...
          <p className="mt-4 max-w-2xl text-lg md:text-xl">
            <TranslatedText>
              Discover our new collection of timeless pieces, crafted with passion and precision.
            </TranslatedText>
          </p>
          <Button asChild className="mt-8" size="lg">
            <Link href="/products/all"><TranslatedText>Shop Now</TranslatedText></Link>
          </Button>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5">
            {categories.map((category) => {
              ...
              return (
                <Link href={`/products/${category.slug}`} key={category.id} className="group relative block overflow-hidden rounded-md">
                   {categoryImage && (
                    <Image
