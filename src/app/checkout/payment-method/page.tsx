  ...
  return (
    <div className="container mx-auto max-w-6xl px-4 py-12">
      <h1 className="mb-8 text-center font-headline text-4xl md:text-5xl">
        <TranslatedText fr="Paiement" en="Checkout">
          Kasse
        </TranslatedText>
      </h1>
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
        <Card className="rounded-lg border shadow-sm">
          <CardHeader>
            <CardTitle>
                <TranslatedText fr="Informations de livraison" en="Shipping Information">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Button type="submit" size="lg" className="w-full" disabled={isSubmitting}>
                  ...
                  <TranslatedText fr="Continuer vers le paiement" en="Continue to Payment">
                    Weiter zur Zahlung
                  </TranslatedText>
                </Button>
              </form>
        ...
        <div className="h-fit rounded-lg bg-muted/50 p-6 lg:p-8">
          <h2 className="mb-6 font-headline text-2xl">
            <TranslatedText fr="Récapitulatif de la commande" en="Order Summary">
              Bestellübersicht
            </TranslatedText>
          </h2>
