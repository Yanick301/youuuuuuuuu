...
export function CheckoutClientPage() {
  ...
  if (cartItems.length === 0) {
      // Maybe show a message and redirect
       return (
        ...
        <main className="border-r border-gray-200 px-4 pb-20 pt-8 sm:px-6 lg:px-8">
            ...
            <Form {...form}>
                ...
                <div className="mt-10 border-t border-gray-200 pt-6 sm:flex sm:items-center sm:justify-between">
                    <Button type="submit" className="w-full sm:w-auto">Continue to shipping</Button>
                    <p className="mt-4 text-center text-sm text-gray-500 sm:mt-0 sm:text-left">
                        <Link href="/cart" className="text-gray-600 hover:text-gray-800 font-medium flex items-center gap-2 justify-center">
